...
@Composable
fun MainScreen(booksState: BooksState, onBookSelected: (Book) -> Unit) {
...
@Composable
fun BookList(books: List<Book>, onBookSelected: (Book) -> Unit) {
    LazyColumn {
        items(books) { book ->
...
@Composable
fun BookItem(book: Book, onClicked: (Book) -> Unit) {
    ElevatedCard(
        modifier = Modifier
            .padding(8.dp)
            .fillMaxWidth(),
